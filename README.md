...
VYaml-Net is a pure C# YAML 1.2.2 implementation which is very fast with a low memory footprint and minimal dynamic allocations. It is focused on modern .NET and C# requiring .NET 11 and C# 14 at time of writing.

It is a fork of the excellent [VYaml](https://github.com/hadashiA/VYaml) library and all credit goes to [hadashiA](https://github.com/hadashiA) for implementing it. The main contribution from this fork is dropping the Unity restrictions and modernizing it to the latest .NET environment.
...
- YAML Parser (Reader)
  ...
  - Support Unity serialized weird YAML format (but not for much longer)
